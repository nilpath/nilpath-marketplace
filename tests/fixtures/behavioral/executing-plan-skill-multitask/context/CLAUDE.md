...
- Follow all other skill instructions exactly as written, including agent delegation and code-reviewer steps
- Treat each task as atomic — never bundle multiple tasks into a single agent invocation, even if they look similar
